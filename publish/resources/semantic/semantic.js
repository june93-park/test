            ...
            create: {
              calendar: function () {
                ...
                if (!isTimeOnly) {
                  ...
                  var monthWrap = $('<div/>').addClass('month-wrap').appendTo(cell);

                  var headerText = $('<span/>').addClass(className.link).appendTo(monthWrap);
                  ...
                  var arrowWrap = $('<div/>').addClass('arrow-wrap').appendTo(monthWrap);
  
                  var prev = $('<span/>').addClass(className.prev).appendTo(arrowWrap);
                  prev.data(metadata.focusDate, prevDate);
                  prev.toggleClass(className.disabledCell, !module.helper.isDateInRange(prevLast, mode));
                  $('<i/>').addClass(className.prevIcon).appendTo(prev);
  
                  var next = $('<span/>').addClass(className.next).appendTo(arrowWrap);
      ...
      popup: function(text) {
        ...
        if(typeof text !== undefined) {
          ...
          if(typeof text.content !== undefined && text.content) {
            ...
            html += '<div class="scrolling content">' + text.content + '</div>';
          }
        }
        return html;
      }
